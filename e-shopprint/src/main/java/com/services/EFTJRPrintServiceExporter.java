 ...
 * FileName:EFTJRPrintServiceExporter.java 
 * Author: bandari
 * Date: 2016年1月4日 下午12:23:09
 ...
 * @author Teodor Danciu (teodord@users.sourceforge.net) recreated qirun 2016/01/04
 * @version $Id: JRPrintServiceExporter.java 7063 2014-04-29 09:37:53Z shertage $
 */
public class EFTJRPrintServiceExporter extends JRAbstractExporter<PrintServiceReportConfiguration, PrintServiceExporterConfiguration, ExporterOutput, JRExporterContext> implements Printable
{
	 ...
	 */
	public EFTJRPrintServiceExporter()
	{
	 ...
	 *
	 */
	public EFTJRPrintServiceExporter(JasperReportsContext jasperReportsContext)
	{
...
//				exporter.setParameter(JRExporterParameter.FILE_RESOLVER, fileResolver);
				...
				try 
				{
					...
					else
					{
	                    ...
	                    if (((PrinterIsAcceptingJobs)(printerJob.getPrintService().getAttribute(PrinterIsAcceptingJobs.class))) == PrinterIsAcceptingJobs.NOT_ACCEPTING_JOBS){
	                   String not_accepting_jobs = "打印机拒绝为此次打印服务，请检查打印机是否能正常工作！";
	                    System.out.println(not_accepting_jobs);
	                    new PrinterException(not_accepting_jobs);
	                    return;
	                    }	                    
						printerJob.print(printRequestAttributeSet);
					}
