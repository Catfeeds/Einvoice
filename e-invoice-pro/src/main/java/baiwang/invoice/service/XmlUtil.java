...
public class XmlUtil {
	 ...
	 */
	    ...
	    public Map xmlToMap(String rtnXml){
		
			
			if(rtnXml == null || "".equalsIgnoreCase(rtnXml)){
				return null;
			}
			...
			Document document;
			try {
				document = DocumentHelper.parseText(rtnXml);
				Element rootElement = document.getRootElement();
				
				List elements = rootElement.elements();
				
				for(Object eleObject : elements){
					Element ele = (Element)eleObject;
					//System.out.println(ele.getName()+"  "+ele.getText());
					reMap.put(ele.getName(), ele.getText());
