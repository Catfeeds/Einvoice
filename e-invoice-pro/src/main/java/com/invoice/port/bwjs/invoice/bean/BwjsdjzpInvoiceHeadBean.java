...
//开具发票需要的发票头信息
public class BwjsdjzpInvoiceHeadBean {
	...
	private  BwjsdjzpZpInvoiceDetailList detailList;
	...
	public BwjsdjzpZpInvoiceDetailList getDetailList() {
		return detailList;
	}
	public void setDetailList(BwjsdjzpZpInvoiceDetailList detailList) {
	...
	private BwjsdjzpRtInvoiceBean rtBean;
	...
	public BwjsdjzpRtInvoiceBean getRtBean() {
		return rtBean;
	}
	public void setRtBean(BwjsdjzpRtInvoiceBean rtBean) {
		this.rtBean = rtBean;
	}
