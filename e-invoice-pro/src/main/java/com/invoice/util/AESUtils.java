...
public class AESUtils {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        AESUtils util = new AESUtils("E777A63D300440C0"); // 密钥
        System.out.println("加密:"+util.encryptData("01041109020190603")); // 加密
        System.out.println("解密:"+util.decryptData("YfmLNxKIqSbvAC/B2NDVvwXbMp8/euJAT3LT4h2Uviw=")); // 解密
    }
