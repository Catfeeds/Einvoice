...
public class RtnData2 {
	...
	public RtnData2(String code, String message){
		this.code = code;
		this.message = message;
		this.data = null;
	}
	
	public RtnData2(Object obj){
		this.code = "0";
		this.message = "";
		setData(obj);
	}
	
	public RtnData2(Object obj,String count){
		setData(obj);
		this.count = count;
	}
	
	public RtnData2(String code, String message,Object obj){
		this.code = code;
		this.message = message;
		setData(obj);
	}
