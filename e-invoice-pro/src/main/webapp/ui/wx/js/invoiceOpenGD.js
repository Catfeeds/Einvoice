...
function commit(){
    ...
    $.myAjax({
        ...
        success: function (dataJson) {
            ...
            $.myConfirm({title:"成功",msg:"稍后电子发票将发送到您的手机和邮箱，请注意查收",btn1:"继续开票",btn2:"查看开票",onCancel:function(){window.location.reload();},onConfirm:function(){$.gotoUrl('./invoiceViewGD.html?iqseqno='+iqseqno);}});
        },
        error: function (jqXHR, textStatus, errorThrown) {
            isLoading=false;
            $.myAlert("访问后台失败! status:"+textStatus+" msg:"+jqXHR.responseText);
