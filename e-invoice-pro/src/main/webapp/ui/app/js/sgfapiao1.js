...
function instax(){
	...
	var tempE = selectTr.find("input[name='taxrate']");
	tempE.val(taxrate);
	
	tempE = selectTr.find("input[name='taxitemname']");
	tempE.val(taxitemname);
	
	tempE = selectTr.find("select[name='taxpre']");
	tempE.val(taxpre);
	tempE = selectTr.find("input[name='taxprecon']");
	tempE.val(taxprecon);
	tempE = selectTr.find("select[name='zerotax']");
	tempE.val(zerotax);
...
function add(){
    ...
    add.attr("id","sg"+$("#table1 tr").length);
