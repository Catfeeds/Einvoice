...
<template>
  <div style="padding:10px 5px;">
    <div style="height:280px;top:0px;">
    ...
    <div class="info">
      ...
      <div class="info-content" v-show="helpDisplay">
        ...
        <p class="info-content-m">可通过扫描销售小票上的二维码进行开具发票。</p>

        <van-row gutter="10">
            <p style="text-align:center;font-size:14px;font-weight: bold;">免税销售小票</p>
...
<script>
import b123 from "../../images/b123.jpg";
